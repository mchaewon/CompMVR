...
class UNet2DConditionModel(ModelMixin, ConfigMixin, UNet2DConditionLoadersMixin):
    ...
    def forward(
        ...
        # cross attention in down blocks (text conditioning)
        ...
        # 4. mid
        # cross attention in mid blocks (text conditioning)
        ...
        for i, upsample_block in enumerate(self.up_blocks):
            ...
            # cross attention in up blocks (text conditioning)
